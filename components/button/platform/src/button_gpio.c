 ...
 */
static esp_err_t _button_init(button_gpio_t *p_btn);

/**
 * @brief The function checks if the button is pressed.
 *
 * @param [in] p_btn a pointer to the button_gpio_t structure that was passed to the button_gpio_init()
 * function.
 *
