...
button_err_t button_init(button_id_t btn_id, button_pressed_t p_btn_cb)
{
    ...
    button_gpio_t *p_button = button_gpio_create(_button_info[btn_id].pin, _button_info[btn_id].b_is_active_on_high_level, p_btn_cb);
